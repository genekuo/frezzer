...
describe('fetchEmployees()', function () {
    it('should display the REQUEST action when the action is dispatched', function () {
        const spy = jest.fn();
    ...
    it('should dispath the SUCCESS action when the data is fetched successfully', function () {
    ...
    it('should dispath the FAILURE action when the data is not available', function () {
        const mockAxios = new MockAdapter(axios);
